...
class _ContactAddScreenState extends State<ContactAddScreen> {
  ...
  Future<void> _init() async{
    cachedContact=await LocalDatabase.getAllCachedContact();
    setState((){});
  }
  @override
  void initState() {
            ...
            children: [
              ...
              TextButton(
                  onPressed: () async {
                    ...
                    var ob= CachedContact(fullName: fullNameText, phone: phoneText);
                    await LocalDatabase.insertCachedContact(ob);
